		...
		scrollLoad : function(){
			...
			me.ajax('/summary/dailyList',parames,function(data){
				...
				if(dataList && dataList.length>0){//有数据
					...
					$('#totalStock').append(tmpl($('#totalStockTMP').text(),dataList));
					$('#totalCapitalOnCall').append(tmpl($('#totalCapitalOnCallTMP').text(),dataList));
					$('#principalOnCall').append(tmpl($('#principalOnCallTMP').text(),dataList));
					$('#interestOnCall').append(tmpl($('#interestOnCallTMP').text(),dataList));
					$('#capitalOnCallPersonNum').append(tmpl($('#capitalOnCallPersonNumTMP').text(),dataList));
					$('#balanceAmount').append(tmpl($('#balanceAmountTMP').text(),dataList));
					$('#balancePersonNum').append(tmpl($('#balancePersonNumTMP').text(),dataList));
					$('#investUnconfirmedAmount').append(tmpl($('#investUnconfirmedAmountTMP').text(),dataList));
					$('#investUnconfirmedPersonNum').append(tmpl($('#investUnconfirmedPersonNumTMP').text(),dataList));
					$('#investConfirmedAmount').append(tmpl($('#investConfirmedAmountTMP').text(),dataList));
					$('#rechargeAmount').append(tmpl($('#rechargeAmountTMP').text(),dataList));
					$('#withdrawAmount').append(tmpl($('#withdrawAmountTMP').text(),dataList));
					$('#registeredPersonNum').append(tmpl($('#registeredPersonNumTMP').text(),dataList));
					$('#cardPersonNum').append(tmpl($('#cardPersonNumTMP').text(),dataList));
					$('#investPersonNum').append(tmpl($('#investPersonNumTMP').text(),dataList));
					$('#multipleInvestPersonNum').append(tmpl($('#multipleInvestPersonNumTMP').text(),dataList));
					$('#dailyInvestAmount').append(tmpl($('#dailyInvestAmountTMP').text(),dataList));
					$('#dailyInvestPersonNum').append(tmpl($('#dailyInvestPersonNumTMP').text(),dataList));
					$('#dailyMultipleInvestPersonNum').append(tmpl($('#dailyMultipleInvestPersonNumTMP').text(),dataList));
					$('#dailyRechargeAmount').append(tmpl($('#dailyRechargeAmountTMP').text(),dataList));
					$('#dailyWithdrawAmount').append(tmpl($('#dailyWithdrawAmountTMP').text(),dataList));
					$('#dailyRegisteredPersonNum').append(tmpl($('#dailyRegisteredPersonNumTMP').text(),dataList));
					$('#dailyCardPersonNum').append(tmpl($('#dailyCardPersonNumTMP').text(),dataList));
					me.currentPage++;
				}else{
					alert('没有更多数据');
				}	
